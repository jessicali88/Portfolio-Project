...
I will use Queue to model my FitnessTracker. Specifically, I want to use the Java version. I chose this because the kernel methods for Queue are very similar to the kernel methods I already created.
